          ...
          action={(
            <div className="flex items-center gap-2 max-w-full overflow-x-auto whitespace-nowrap">
              <a
                ...
                className="shrink-0 p-2 rounded-lg border border-[#daaa00] text-[#daaa00] hover:bg-[#daaa00] hover:text-black transition flex items-center justify-center"
                title="YouTube"
              >
